...
+ [Example 1: Bucket Owner Granting Its Users Bucket Permissions ](example-walkthroughs-managing-access-example1.mdx)
...
+ [Example 2: Bucket Owner Granting Cross\-Account Bucket Permissions ](example-walkthroughs-managing-access-example2.mdx)
...
+ **Managing object permissions when the object and bucket owners are not the same**
  ...
  + [Example 3: Bucket Owner Granting Its Users Permissions to Objects It Does Not Own ](example-walkthroughs-managing-access-example3.mdx)

...
The following Amazon S3 REST APIs support headers related to server\-side encryption with customer\-provided encryption keys\. For more information about these headers, see [Using SSE\-C](ServerSideEncryptionCustomerKeys.mdx#sse-c-how-to-programmatically-intro)\. 

...
For examples of deleting objects using the AWS SDKs for Java, \.NET, and PHP, see [Deleting Objects](DeletingObjects.mdx)\. The examples for deleting objects in nonversioned and versioning\-enabled buckets are the same, although in the case of versioning\-enabled buckets, Amazon S3 assigns a version number\. Otherwise, the version number is null\. 
...
## Related Topics<a name="delete-obj-version-enabled-related-topics"></a>
 ...
 [Using MFA Delete](UsingMFADelete.mdx) 

 [Working with Delete Markers](DeleteMarker.mdx) 

 [Removing Delete Markers](RemDelMarker.mdx) 

 [Using Versioning](Versioning.mdx) 
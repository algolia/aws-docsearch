...
1. Follow the step\-by\-step instructions in [Example 1: Configuring for Buckets in the Same Account](replication-walkthrough1.mdx) with the following changes:

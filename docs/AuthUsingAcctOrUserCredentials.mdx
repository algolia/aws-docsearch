...
**Topics**
+ [Making Requests Using AWS Account or IAM User Credentials \- AWS SDK for Java](AuthUsingAcctOrUserCredJava.mdx)
+ [Making Requests Using AWS Account or IAM User Credentials \- AWS SDK for \.NET](AuthUsingAcctOrUserCredDotNet.mdx)
+ [Making Requests Using AWS Account or IAM User Credentials \- AWS SDK for PHP](AuthUsingAcctOrUserCredPHP3.mdx)
+ [Making Requests Using AWS Account or IAM User Credentials \- AWS SDK for Ruby](AuthUsingAcctOrUserCredRuby.mdx)

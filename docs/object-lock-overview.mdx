...
For information about managing the lock status of your Amazon S3 objects, see [Managing Amazon S3 Object Locks](object-lock-managing.mdx)\.

**Note**  
 S3 buckets with Amazon S3 object lock cannot be used as destination buckets for [Amazon S3 Server Access Logging](ServerLogs.mdx)
...
## Required Permissions<a name="object-lock-permissions"></a>
 ...
 Amazon S3 object lock operations require specific permissions\. For more information, see [Permissions for Object Operations](using-with-s3-actions.mdx#using-with-s3-actions-related-to-objects)\.
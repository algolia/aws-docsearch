...
An object version can have both a retention period and a legal hold, one but not the other, or neither\. For more information, see [Amazon S3 Object Lock Overview](object-lock-overview.mdx)\. 
...
**Topics**
+ [Amazon S3 Object Lock Overview](object-lock-overview.mdx)
+ [Managing Amazon S3 Object Locks](object-lock-managing.mdx)
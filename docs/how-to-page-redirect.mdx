...
For more information about the endpoints, see [Key Differences Between the Amazon Website and the REST API Endpoint](WebsiteEndpoints.mdx#WebsiteRestEndpointDiff)\.

---
id: creating-access-points
title: Creating Access Points
---
...
**Note**  
The `"Resource"` declaration in this example uses an Amazon Resource Name \(ARN\) to specify the access point\. For more information about access point ARNs, see [Using Access Points](using-access-points.mdx)\. 
...
For more information about the S3 Block Public Access feature, see [Using Amazon S3 Block Public Access](access-control-block-public-access.mdx)\.
...
For more information about using condition keys with Amazon S3, see [Specifying Conditions in a Policy](amazon-s3-policy-keys.mdx)\.

...
**Error Code**  
The Amazon S3 [Error Code](ErrorCode.mdx), or "\-" if no error occurred\.  
**Example Entry**  
...
```
Some older Regions support legacy endpoints\. You may see these endpoints in your server access logs or CloudTrail logs\. For more information, see [Legacy Endpoints](VirtualHosting.mdx#s3-legacy-endpoints)\. For a complete list of Amazon S3 Regions and endpoints, see [Amazon S3 Regions and Endpoints](https://docs.aws.amazon.com/general/latest/gr/s3.html) in the *AWS General Reference*\.
...
**Error Code**  
The Amazon S3 [Error Code](ErrorCode.mdx), of the `GET` portion of the copy operation or "\-" if no error occurred\.  
**Example Entry**  

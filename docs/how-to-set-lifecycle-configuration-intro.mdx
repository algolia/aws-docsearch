---
id: how-to-set-lifecycle-configuration-intro
title: Setting Lifecycle Configuration on a Bucket
---
# Setting Lifecycle Configuration on a Bucket<a name="how-to-set-lifecycle-configuration-intro"></a>

**Topics**
+ [Manage an Object's Lifecycle Using the Amazon S3 Console](manage-lifecycle-using-console.mdx)
+ [Set Lifecycle Configurations Using the AWS CLI](set-lifecycle-cli.mdx)
+ [Managing Object Lifecycles Using the AWS SDK for Java](manage-lifecycle-using-java.mdx)
+ [Manage an Object's Lifecycle Using the AWS SDK for \.NET](manage-lifecycle-using-dot-net.mdx)
+ [Manage an Object's Lifecycle Using the AWS SDK for Ruby](manage-lifecycle-using-ruby.mdx)
+ [Manage an Object's Lifecycle Using the REST API](manage-lifecycle-using-rest.mdx)
...
For information about lifecycle configuration, see [Object Lifecycle Management](object-lifecycle-mgmt.mdx)\.
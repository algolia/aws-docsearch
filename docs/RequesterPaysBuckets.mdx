...
**Topics**
+ [Configure Requester Pays by Using the Amazon S3 Console](configure-requester-pays-console.mdx)
+ [Configure Requester Pays with the REST API](configure-requester-pays-rest.mdx)

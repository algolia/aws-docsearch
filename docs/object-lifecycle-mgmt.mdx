...
+ **Expiration actions**—Define when objects expire\. Amazon S3 deletes expired objects on your behalf\. 
  ...
  The lifecycle expiration costs depend on when you choose to expire objects\. For more information, see [Understanding Object Expiration](lifecycle-expire-general-considerations.mdx)\.

For more information about lifecycle rules, see [Lifecycle Configuration Elements](intro-lifecycle-rules.mdx)\. 
...
+ [Additional Considerations for Lifecycle Configuration](lifecycle-additional-considerations.mdx)
+ [Lifecycle Configuration Elements](intro-lifecycle-rules.mdx)
+ [Examples of Lifecycle Configuration](lifecycle-configuration-examples.mdx)

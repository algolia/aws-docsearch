...
**Topics**
+ [Example: Setting up a Static Website](HostingWebsiteOnS3Setup.mdx)
+ [Example: Setting Up a Static Website Using a Custom Domain](website-hosting-custom-domain-walkthrough.mdx)
+ [Example: Speed Up Your Website with Amazon CloudFront](website-hosting-cloudfront-walkthrough.mdx)
+ [Clean Up Your Example Resources](getting-started-cleanup.mdx)

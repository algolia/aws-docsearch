...
**Note**  
 ...
 For more information on this aspect of listing, see [Listing Keys Hierarchically Using a Prefix and Delimiter](ListingKeysHierarchy.mdx)\. 
...
+ [Listing Keys Using the AWS SDK for Java](ListingObjectKeysUsingJava.mdx)
+ [Listing Keys Using the AWS SDK for \.NET](ListingObjectKeysUsingNetSDK.mdx)

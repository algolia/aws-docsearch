...
For more information about creating an Amazon S3 batch operations job, see [Creating an Amazon S3 Batch Operations Job](batch-ops-create-job.mdx) and [Operations](batch-ops-operations.mdx)\.

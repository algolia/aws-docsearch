...
For more information, see [Object Lifecycle Management](object-lifecycle-mgmt.mdx)\. 

### Object Tagging and Replication<a name="tagging-and-replication"></a>

If you configured Replication on your bucket, Amazon S3 replicates tags, provided you grant Amazon S3 permission to read the tags\. For more information, see [Overview of Setting Up Replication](replication-how-setup.mdx)\.
...
+  [Permissions for Object Operations](using-with-s3-actions.mdx#using-with-s3-actions-related-to-objects) 
+  [Permissions Related to Bucket Operations](using-with-s3-actions.mdx#using-with-s3-actions-related-to-buckets)
...
For a complete list of Amazon S3 service\-specific condition keys, see [Available Condition Keys](amazon-s3-policy-keys.mdx#AvailableKeys-iamV2)\. The following permissions policies illustrate how object tagging enables fine grained access permissions management\.
...
**Related Topics**  
[Managing Object Tags](tagging-managing.mdx)
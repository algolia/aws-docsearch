...
**Topics**
+ [Upload an Object Using a Presigned URL \(AWS SDK for Java\)](PresignedUrlUploadObjectJavaSDK.mdx)
+ [Upload an Object to an S3 Bucket Using a Presigned URL \(AWS SDK for \.NET\)](UploadObjectPreSignedURLDotNetSDK.mdx)
+ [Upload an Object Using a Presigned URL \(AWS SDK for Ruby\)](UploadObjectPreSignedURLRubySDK.mdx)
...
For instructions about how to install AWS Explorer, see [Using the AWS SDKs, CLI, and Explorers](UsingAWSSDK.mdx)\.

...
For more information about multipart uploads, see [Multipart Upload Overview](mpuoverview.mdx)\.

**Topics**
+ [Uploading Objects in a Single Operation](UploadInSingleOp.mdx)
+ [Uploading Objects Using Multipart Upload API](uploadobjusingmpu.mdx)
+ [Uploading Objects Using Presigned URLs](PresignedUrlUploadObject.mdx)

When uploading an object, you can optionally request that Amazon S3 encrypt it before saving it to disk, and decrypt it when you download it\. For more information, see [Protecting Data Using Encryption](UsingEncryption.mdx)\. 

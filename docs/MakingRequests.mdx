...
+ [Making Requests to Amazon S3 over IPv6](ipv6-access.mdx)
+ [Making Requests Using the AWS SDKs](MakingAuthenticatedRequests.mdx)
+ [Making Requests Using the REST API](RESTAPI.mdx)
...
For information on signing requests using temporary security credentials in your REST API requests, see [Signing and Authenticating REST Requests](RESTAuthentication.mdx)\. For information about sending requests using AWS SDKs, see [Making Requests Using the AWS SDKs](MakingAuthenticatedRequests.mdx)\. 

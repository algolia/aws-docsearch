---
id: set-lifecycle-cli
title: Set Lifecycle Configurations Using the AWS CLI
---
...
For instructions to set up the AWS CLI, see [Setting Up the AWS CLI](setup-aws-cli.mdx)\.

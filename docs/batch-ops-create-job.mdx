...
**Manifest**  
The manifest is a list of all of the objects that you want Amazon S3 batch operations to execute the specified action on\. You can use a CSV\-formatted [ Amazon S3 Inventory](storage-inventory.mdx) report as a manifest or use your own customized CSV list of objects\. For more information about manifests, see [Specifying a Manifest](batch-ops-basics.mdx#specify-batchjob-manifest)\.
...
+ [The Basics: Amazon S3 Batch Operations Jobs](batch-ops-basics.mdx)
+ [Operations](batch-ops-operations.mdx)
+ [Managing Batch Operations Jobs](batch-ops-managing-jobs.mdx)
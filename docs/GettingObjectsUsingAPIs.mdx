...
+ [Get an Object Using the AWS SDK for Java](RetrievingObjectUsingJava.mdx)
+ [Get an Object Using the AWS SDK for \.NET](RetrievingObjectUsingNetSDK.mdx)
+ [Get an Object Using the AWS SDK for PHP](RetrieveObjSingleOpPHP.mdx)
+ [Get an Object Using the REST API](RetrieveObjSingleOpREST.mdx)
+ [Share an Object with Others](ShareObjectPreSignedURL.mdx)
...
When retrieving objects that are stored encrypted using server\-side encryption you will need to provide appropriate request headers\. For more information, see [Protecting Data Using Encryption](UsingEncryption.mdx)\.

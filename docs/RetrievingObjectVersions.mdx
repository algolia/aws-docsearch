...
For examples of uploading objects using AWS SDKs for Java, \.NET, and PHP, see [Getting Objects](GettingObjectsUsingAPIs.mdx)\. The examples for uploading objects in a nonversioned and versioning\-enabled buckets are the same, although in the case of versioning\-enabled buckets, Amazon S3 assigns a version number\. Otherwise, the version number is null\. 
...
## Related Topics<a name="retrieve-obj-versioning-enabled-related-topics"></a>
 ...
 [Retrieving the Metadata of an Object Version](RetMetaOfObjVersion.mdx) 
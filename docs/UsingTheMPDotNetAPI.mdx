...
+ **Amazon\.S3—**Provides the implementation for the low\-level APIs\. 
  ...
  It provides methods that correspond to the Amazon S3 REST multipart upload API \(see [Using the REST API for Multipart Upload](UsingRESTAPImpUpload.mdx)\)\.

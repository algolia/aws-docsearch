...
**Note**  
We recommend that you use AWS CloudTrail data events instead of Amazon S3 access logs\. CloudTrail data events are easier to set up and contain more information\. For more information, see [ Using AWS CloudTrail to Identify Amazon S3 Requests](cloudtrail-request-identification.mdx)\.
...
1. You can then enable the Amazon S3 access logs using the following methods:
   ...
   + [Enabling Logging Programmatically](enable-logging-programming.mdx) or, 
...
**Note**  
We recommend that you use AWS CloudTrail data events instead of Amazon S3 access logs\. CloudTrail data events are easier to set up and contain more information\. For more information, see [Using AWS CloudTrail to Identify Amazon S3 Signature Version 2 Requests ](cloudtrail-request-identification.mdx#cloudtrail-identification-sigv2-requests)\.
...
If you are using Amazon S3 AWS CloudTrail logs, see [Using AWS CloudTrail to Identify Access to Amazon S3 Objects](cloudtrail-request-identification.mdx#cloudtrail-identification-object-access)\. 

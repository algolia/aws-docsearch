...
+ [Deleting One Object Per Request](DeletingOneObject.mdx)
+ [Deleting Multiple Objects Per Request](DeletingMultipleObjects.mdx)
...
For information on MFA delete, see [MFA Delete](Versioning.mdx#MultiFactorAuthenticationDelete)\.

...
**Topics**
+ [Deleting Multiple Objects Using the AWS SDK for Java](DeletingMultipleObjectsUsingJava.mdx)
+ [Deleting Multiple Objects Using the AWS SDK for \.NET](DeletingMultipleObjectsUsingNetSDK.mdx)
+ [Deleting Multiple Objects Using the AWS SDK for PHP](DeletingMultipleObjectsUsingPHPSDK.mdx)
+ [Deleting Multiple Objects Using the REST API](DeletingMultipleObjectsUsingREST.mdx)
...
To learn more about object deletion, see [Deleting Objects](DeletingObjects.mdx)\. 

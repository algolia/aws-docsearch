...
+ [Implement server-side encryption](security-best-practices.mdx#server-side)
+ [Enforce encryption of data in transit](security-best-practices.mdx#transit)
+ [Consider using Amazon Macie with Amazon S3](security-best-practices.mdx#macie)

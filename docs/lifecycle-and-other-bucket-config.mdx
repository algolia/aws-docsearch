---
id: lifecycle-and-other-bucket-config
title: Lifecycle and Other Bucket Configurations
---
...
You can add lifecycle configurations to unversioned buckets and versioning\-enabled buckets\. For more information, see [Object Versioning](ObjectVersioning.mdx)\. 
...
For more information, see [Lifecycle Configuration Elements](intro-lifecycle-rules.mdx)\. For information about versioning, see [Object Versioning](ObjectVersioning.mdx)\.
...
+ [Lifecycle Configuration Elements](intro-lifecycle-rules.mdx) 
+ [Transitioning to the GLACIER and DEEP ARCHIVE Storage Classes \(Object Archival\)](lifecycle-transition-general-considerations.mdx#before-deciding-to-archive-objects)
+ [Setting Lifecycle Configuration on a Bucket](how-to-set-lifecycle-configuration-intro.mdx) 
...
Replication events are available within 15 minutes of enabling S3 RTC\. Amazon S3 events are available through Amazon SQS, Amazon SNS, or AWS Lambda\. For more information, see [Event Notification Types and Destinations](NotificationHowTo.mdx#notification-how-to-event-types-and-destinations)\.
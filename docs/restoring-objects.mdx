...
For information about using lifecycle transitions to move objects to the GLACIER or DEEP ARCHIVE storage classes, see [Transitioning to the GLACIER and DEEP ARCHIVE Storage Classes \(Object Archival\)](lifecycle-transition-general-considerations.mdx#before-deciding-to-archive-objects)\.
...
+ [Restore an Archived Object Using the Amazon S3 Console](restoring-objects-console.mdx)
+ [Restore an Archived Object Using the AWS SDK for Java](restoring-objects-java.mdx)
+ [Restore an Archived Object Using the AWS SDK for \.NET](restore-object-dotnet.mdx)
+ [Restore an Archived Object Using the REST API](restoring-objects-rest.mdx)

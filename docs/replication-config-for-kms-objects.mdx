...
For an example with step\-by\-step instructions, see [Example 4: Replicating Encrypted Objects](replication-walkthrough-4.mdx)\. For information about creating a replication configuration, see [Replication](replication.mdx)\. 

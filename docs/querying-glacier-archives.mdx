---
id: querying-glacier-archives
title: Querying Archived Objects
---
...
+ The requesting AWS account must have permissions to perform the `s3:RestoreObject` and `s3:GetObject` actions\. For more information about these permissions, see [Permissions Related to Bucket Subresource Operations](using-with-s3-actions.mdx#using-with-s3-actions-related-to-bucket-subresources)\. 

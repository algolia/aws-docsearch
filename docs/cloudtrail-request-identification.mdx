...
Amazon S3 lets you identify requests using an AWS CloudTrail event log\. AWS CloudTrail is the preferred way of identifying Amazon S3 requests, but if you are using Amazon S3 server access logs, see [ Using Amazon S3 Access Logs to Identify Requests](using-s3-access-logs-to-identify-requests.mdx)\.
...
For information about what Amazon S3 API calls are captured by CloudTrail, see [Amazon S3 Information in CloudTrail](cloudtrail-logging.mdx#cloudtrail-logging-s3-info)\. 
...
AWS CloudTrail is the preferred method for identifying Signature Version 2 requests, if you are using Amazon S3 server access logs, see [ Using Amazon S3 Access Logs to Identify Signature Version 2 Requests ](using-s3-access-logs-to-identify-requests.mdx#using-s3-access-logs-to-identify-sigv2-requests)
...
If you are using Amazon S3 server access logs, see [ Using Amazon S3 Access Logs to Identify Object Access Requests](using-s3-access-logs-to-identify-requests.mdx#using-s3-access-logs-to-identify-objects-access)\.
